...
class fs_dutch_language_package extends StdModule
{
  function __construct() 
  {
    $this->init('MODULE_FS_DUTCH_LANGUAGE_PACKAGE');
    $this->keys_dispnone = ['MODULE_FS_DUTCH_LANGUAGE_PACKAGE_STATUS'];
  }
  ...
  function getDescription()
  {
    ...
    $languages_id_query = xtc_db_query("SELECT languages_id, status, status_admin FROM languages WHERE code = 'nl'");
  ...
  function display() 
  {
    ...
    return ['text' => $description . '<br /><div align="center">' . xtc_button(BUTTON_EDIT) .
            xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_MODULE_EXPORT, 'set=' . $_GET['set'] . '&module=fs_dutch_language_package')) . "</div>"];
  }
  ...
  function install() 
  {
    ...
    $stdLanguageModule->init($dutchLanguageData, 0);
    parent::install();
  ...
  {
    $stdLanguageModule = new StdLanguageModule;
    $stdLanguageModule->setLanguageIdByCode('nl');
