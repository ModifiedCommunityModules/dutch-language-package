...
if (!defined('MODULE_FS_DUTCH_LANGUAGE_PACKAGE_STATUS') || MODULE_FS_DUTCH_LANGUAGE_PACKAGE_STATUS != 'true') return;
...
// Check if user is deleting 'fs_dutch_language_package' module
if (!isset($_GET['module']) || $_GET['module'] != 'fs_dutch_language_package') return;
