...
define('MODULE_SHIPPING_UPSE_TEXT_DESCRIPTION', 'United Parcel Service Express - Verzendmodule');
define('MODULE_SHIPPING_UPSE_TEXT_WAY', 'Verzending naar');
define('MODULE_SHIPPING_UPSE_TEXT_UNITS', 'kg');
define('MODULE_SHIPPING_UPSE_INVALID_ZONE', 'Helaas is er geen verzending naar dit land mogelijk.');
define('MODULE_SHIPPING_UPSE_UNDEFINED_RATE', 'De verzendkosten kunnen op dit moment niet worden berekend.');

define('MODULE_SHIPPING_UPSE_STATUS_TITLE' , 'UPS Express');
define('MODULE_SHIPPING_UPSE_STATUS_DESC' , 'Wilt u verzending via UPS Express aanbieden?');
define('MODULE_SHIPPING_UPSE_HANDLING_TITLE' , 'Supplement');
define('MODULE_SHIPPING_UPSE_HANDLING_DESC' , 'Bearbeitungszuschlag für diese Versandart in Euro');
define('MODULE_SHIPPING_UPSE_TAX_CLASS_TITLE' , 'Belastingtarief');
define('MODULE_SHIPPING_UPSE_TAX_CLASS_DESC' , 'Selecteer het BTW-tarief voor deze verzendmethode.');
define('MODULE_SHIPPING_UPSE_ZONE_TITLE' , 'Verzendingszone');
define('MODULE_SHIPPING_UPSE_ZONE_DESC' , 'Als u een zone selecteert, wordt deze verzendmethode alleen in deze zone aangeboden.');
define('MODULE_SHIPPING_UPSE_SORT_ORDER_TITLE' , 'Weergavevolgorde');
define('MODULE_SHIPPING_UPSE_SORT_ORDER_DESC' , 'Het laagst wordt het eerst weergegeven.');
define('MODULE_SHIPPING_UPSE_ALLOWED_TITLE' , 'Individuele verzendzones');
define('MODULE_SHIPPING_UPSE_ALLOWED_DESC' , 'Geef <b>individueel</b> aan naar welke zones verzending mogelijk moet zijn, bijv: AT,DE.');
