...
define('MODULE_PAYMENT_PAYONE_INVOICE_TEXT_TITLE', 'Factuur');
define('MODULE_PAYMENT_PAYONE_INVOICE_TEXT_DESCRIPTION', 'Betaling op rekening via PayOne');
define('MODULE_PAYMENT_PAYONE_INVOICE_TEXT_INFO', 'contant op factuur');
