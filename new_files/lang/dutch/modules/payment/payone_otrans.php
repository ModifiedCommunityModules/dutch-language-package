...
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_TITLE', 'Online overschrijving');
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_DESCRIPTION', 'Betaling via online bankoverschrijving via PayOne');
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_INFO', 'Betaling via online bankoverschrijving');
