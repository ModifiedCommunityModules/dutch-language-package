...
define('MODULE_PAYMENT_PAYONE_ELV_TEXT_TITLE', 'Automatische incasso');
define('MODULE_PAYMENT_PAYONE_ELV_TEXT_DESCRIPTION', 'ELV betaling via PayOne');
define('MODULE_PAYMENT_PAYONE_ELV_TEXT_INFO', 'automatische incasso');
