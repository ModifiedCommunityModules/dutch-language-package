...
define('MODULE_PAYMENT_PAYONE_CC_TEXT_TITLE', 'Creditcards');
define('MODULE_PAYMENT_PAYONE_CC_TEXT_DESCRIPTION', 'Creditcardbetaling met creditcards via PayOne');
define('MODULE_PAYMENT_PAYONE_CC_TEXT_INFO', 'Betaal met uw creditcard');
