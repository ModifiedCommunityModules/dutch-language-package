...
define('MODULE_PAYMENT_PAYONE_WLT_TEXT_DESCRIPTION', 'Betaling met e-Wallet via PayOne');
define('MODULE_PAYMENT_PAYONE_WLT_TEXT_INFO', 'Betaling via e-Wallet (PayPal)');
