...
define($prefix.'FEE_TITLE', 'Betalingsmethode toeslag automatische incasso (BillPay)');
define($prefix.'FEE_DESCRIPTION', 'Berekening van de kosten voor bestellingen met de betalingsmethode domiciliëring (BillPay)');
