...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_ORDER_UNDER_INTERNATIONAL_TITLE','Toeslag voor internationale orders onder');
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_ORDER_UNDER_INTERNATIONAL_DESC','Voor internationale bestellingen onder deze waarde wordt een toeslag voor kleine hoeveelheden toegevoegd.');
  ...
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_FEE_INTERNATIONAL_TITLE','Internationale gunning van de opdracht');
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_FEE_INTERNATIONAL_DESC','Toeslag voor kleine hoeveelheden Internationaal.');
