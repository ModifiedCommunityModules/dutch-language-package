...
define('HEADING_TITLE', 'Cache Beheer');

define('TABLE_HEADING_CACHE', 'Cache Blocks');
define('TABLE_HEADING_DATE_CREATED', 'aangemaakt op');
...
define('ERROR_CACHE_DIRECTORY_DOES_NOT_EXIST', 'Fout: Cache directory bestaat niet. Aub invoeren in Configuration / Cache.');
