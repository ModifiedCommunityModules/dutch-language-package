...
define('HEADING_TITLE', 'Verzonden cadeaubonnen');

define('TABLE_HEADING_SENDERS_NAME', 'Naam afzender');
define('TABLE_HEADING_VOUCHER_VALUE', 'waardebon');
define('TABLE_HEADING_VOUCHER_CODE', 'tegoedboncode');
define('TABLE_HEADING_DATE_SENT', 'Datum Verzonden');
define('TABLE_HEADING_ACTION', 'Actie');

define('TEXT_INFO_SENDERS_ID', 'Zender ID:');
define('TEXT_INFO_AMOUNT_SENT', 'Bedrag verzonden:');
define('TEXT_INFO_DATE_SENT', 'Datum verzonden:');
define('TEXT_INFO_VOUCHER_CODE', 'Vouchercode:');
define('TEXT_INFO_EMAIL_ADDRESS', 'E-mailadres:');
define('TEXT_INFO_DATE_REDEEMED', 'Datum Verlost:');
