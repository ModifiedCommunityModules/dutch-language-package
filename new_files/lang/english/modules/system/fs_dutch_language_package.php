<?php
define('MODULE_FS_DUTCH_LANGUAGE_PACKAGE_TITLE', '<img src="../lang/dutch/admin/images/icon.gif" alt="Nederlands" title="Nederlands" style="border:0;"> Dutch language package © by <a href="https://www.shopbetreuung.com/" target="_blank" style="color: #007bff; font-size: inherit; font-weight: inherit;">FishnetServices</a>');
...
define('TEXT_LANGUAGE_DESRIPTION', 'Dutch language package for Modified from version 2.0.5.0.');
define('TEXT_ACTIVE', '<strong style="color:green;">Active</strong>');
define('TEXT_INACTIVE', '<strong style="color:red;">Inactive</strong>');
define('TEXT_LANGUAGE_INSTALLED_SUCCESSFULLY', 'Dutch language was successfully installed.  If you want to copy content from other languages into this language, you can do so <a style="font-size:12px; color:green;" href="languages.php"><strong>here</strong></a>.');
