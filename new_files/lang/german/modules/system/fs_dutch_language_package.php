<?php
define('MODULE_FS_DUTCH_LANGUAGE_PACKAGE_TITLE', '<img src="../lang/dutch/admin/images/icon.gif" alt="Nederlands" title="Nederlands" style="border:0;"> Sprachpaket niederl&auml;ndisch © by <a href="https://www.shopbetreuung.com/" target="_blank" style="color: #007bff; font-size: inherit; font-weight: inherit;">FishnetServices</a>');
...
define('TEXT_LANGUAGE_DESRIPTION', 'Niederl&auml;ndisch Sprachpaket ab Modified 2.0.5.0');
...
define('TEXT_LANGUAGE_INSTALLED_SUCCESSFULLY', 'Sprache niederl&auml;ndisch wurde erfolgreich installiert. Wenn Sie Inhalte aus anderen Sprachen in diese Sprache kopieren m&ouml;chten, k&ouml;nnen Sie dies <a style="font-size:12px; color:green;" href="languages.php"><strong>hier</strong></a> tun.');
